...
app.use(express.static(path.join(__dirname, 'public')));	//configuring express application, setting the path for static files
...
var db = mongojs('devclient:NoobDuck8080@ds119728.mlab.com:19728/newcontactlistdb', ['users']); 
